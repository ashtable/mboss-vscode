# Contributing to mboss-vscode

How this repository is laid out and how to build it. What the extension does
for the people who install it is [README.md](README.md); the architecture and
the rules the tests enforce are [CLAUDE.md](CLAUDE.md).
